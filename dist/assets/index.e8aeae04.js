...
function registerEvent(email, password) {
...
function stateLogin(state) {
  return onAuthStateChanged(auth, state);
}
const currentUserInfo = () => auth.currentUser;
const db = oh(app);
const addANewPost = (customer, postUser, uidUser) => Ql(Ta(db, "posts"), {
  customer,
  postUser,
  uidUser,
  today: rf(),
...
const printPost = (callback) => jl(sl(Ta(db, "posts"), hl("today", "desc")), callback);
const getLikes = (id2) => Ol(Aa(db, "posts", id2));
const addLikes = (docId, uidUser) => {
  Kl(Aa(db, "posts", docId), {
    like: of(uidUser)
  });
};
const removeLikes = (docId, uidUser) => {
  Kl(Aa(db, "posts", docId), {
    like: uf(uidUser)
  });
};
const updateInfo = (displayName) => updateProfile(auth.currentUser, displayName);
const deletePost = (docId) => Gl(Aa(db, "posts", docId));
const editPost = (docId, postUser) => Kl(Aa(db, "posts", docId), { postUser });
const getPost = (docId) => Ol(Aa(db, "posts", docId));
...
const home = (onNavigate2) => {
  ...
  logo.setAttribute("src", "https://github.com/EveCaren/DEV003-social-network/blob/sn-eve/src/img/logo.png");
  ...
  welcome.textContent = `\xA1Bienvenido! Nos alegra que 
  est\xE9s aqu\xED. Petgram es una 
  ...
  buttonLogin.textContent = "Inicia Sesi\xF3n";
      ...
      login(valueEmail, valuePass).then(() => {
        ...
        if (errorCode) {
          if (errorCode === "auth/invalid-email") {
            ...
            Toastify({
              text: "Contrase\xF1a inv\xE1lida.",
              duration: 6e3,
              style: {
                background: "linear-gradient(to right, #f2a71b, #bf522a)"
              }
...
const register = (onNavigate2) => {
  ...
  btnDiv.setAttribute("class", "btnDiv");
  logo.setAttribute("src", "https://github.com/EveCaren/DEV003-social-network/blob/main/src/img/logo.png");
  logo.setAttribute("alt", "logoAlt");
  logo.setAttribute("class", "logo");
  title.setAttribute("class", "title");
  welcome.setAttribute("class", "welcome");
  ...
  labelEmail.textContent = "Correo";
  labelPass.textContent = "Contrase\xF1a";
  RegTitle.textContent = "Reg\xEDstrate";
  buttonCreate.textContent = "Crear cuenta";
  buttonGmail.textContent = "Ingresar con Google  ";
  inputUser.placeholder = "Escriba aqu\xED su usuario";
  inputEmail.placeholder = "Escriba aqu\xED su correo";
  inputPass.placeholder = "Escriba aqu\xED su contrase\xF1a";
  form.addEventListener("submit", (e) => {
    ...
    if (userValue === "" || userValue.length < 5) {
      ...
      registerEvent(mailValue, passValue).then((userCredential) => {
        ...
        onNavigate2("/muro");
        Toastify({
          text: "\xA1Bienvenido a PETGRAM! Ya puedes comenzar a interactuar",
          duration: 5e3,
          style: {
        ...
        if (errorCode) {
          if (errorCode === "auth/invalid-email") {
            ...
            Toastify({
              text: "Correo inv\xE1lido, ya esta en uso.",
              duration: 6e3,
              style: {
                background: "linear-gradient(to right, #f2a71b, #bf522a)"
              }
            ...
            Toastify({
              text: "Su contrase\xF1a es d\xE9bil, ponga al menos 6 caracteres.",
              duration: 6e3,
              style: {
                background: "linear-gradient(to right, #f2a71b, #bf522a)"
              }
...
const muro = (onNavigate2) => {
  ...
  logoButton.setAttribute("src", "https://github.com/EveCaren/DEV003-social-network/blob/sn-eve/src/img/pet-love.png");
  logoButton.setAttribute("alt", "logoAlt");
  buttonProfile.setAttribute("class", "buttonProfile");
  logoProfile.setAttribute("src", "https://github.com/EveCaren/DEV003-social-network/blob/sn-eve/src/img/Max.jpeg");
  logoProfile.setAttribute("alt", "logoAlt");
  buttonLogOut.setAttribute("class", "buttonLogOut");
  logoOut.setAttribute("src", "https://github.com/EveCaren/DEV003-social-network/blob/sn-eve/src/img/logOut.png");
  ...
  write.placeholder = "\xBFEn qu\xE9 est\xE1s pensando? \u{1F43E} ";
  ...
  buttonPublish.addEventListener("click", (e) => {
    ...
    if (postValue !== "") {
      ...
      alert("No has escrito nada, revisa por favor \u{1F63F}");
    }
  });
  function eventLikes() {
  ...
  function eventDelete() {
    ...
    BtnDelete.forEach((btn) => {
      btn.addEventListener("click", () => {
        const question = confirm("\xBFDesea eliminar este post?");
        if (question === true) {
          deletePost(btn.id);
        }
      });
      ...
      contentPost += `<div class = 'cardPost' id = 'cardPost'> 
        ...
        <div class = 'likeDiv'>
          <button class = 'btnLike' id=${doc.id}>
            <img src='https://github.com/EveCaren/DEV003-social-network/blob/sn-eve/src/img/mascotas.png' alt='logolike'>
          </button>
          <p class = 'numLike'>${docData.like.length}</p>
          ${isAuthor ? `<button class = 'btnEdit' id=${doc.id}>
          <img src='https://github.com/EveCaren/DEV003-social-network/blob/sn-eve/src/img/lapiz.png' alt='logolike'>
          </button>
          <button class = 'btnDelete' id=${doc.id}>
          <img src='https://github.com/EveCaren/DEV003-social-network/blob/sn-eve/src/img/eliminar.png' alt='logolike'>
          </button>` : ""}
        </div>
      </div>`;
    });
